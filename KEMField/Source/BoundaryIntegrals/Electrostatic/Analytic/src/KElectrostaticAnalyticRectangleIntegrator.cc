		...
		const KPosition& P) const
{
	...
	double I = (Integral_ln(xmax,ymax,w) -
			Integral_ln(xmin,ymax,w) -
 ...
 * \f]
 */
double KElectrostaticAnalyticRectangleIntegrator
::Integral_ln(double x,double y,double w) const
{
...
double KElectrostaticAnalyticRectangleIntegrator::
EFieldLocalXY(double x1,double x2,double y1,double y2,double z) const
{

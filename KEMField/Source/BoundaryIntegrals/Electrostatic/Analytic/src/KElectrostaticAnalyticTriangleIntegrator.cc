 ...
 */
double KElectrostaticAnalyticTriangleIntegrator::Potential(const KTriangle* source,
...
double KElectrostaticAnalyticTriangleIntegrator::Potential_noZ(double a2,
		double b2,
		double a1,
		double b1,
		double y) const
...
double KElectrostaticAnalyticTriangleIntegrator::I4(double alpha,
		double gamma,
		double q2,
		double prefac,
		double t1,
...
double KElectrostaticAnalyticTriangleIntegrator::I4_2(double alpha,
		double gamma,
		double prefac,
		double t1,
		double t2) const
...
double KElectrostaticAnalyticTriangleIntegrator::Local_Ex(double a0,double a1,
		double b0,double b1,
...
double KElectrostaticAnalyticTriangleIntegrator::Local_Ey(double a0,double a1,
		double b0,double b1,
		double u0,double u1) const
{
	double I2 = 0.;
...
double KElectrostaticAnalyticTriangleIntegrator::Local_Ez(double a0,double a1,
		double b0,double b1,
		double u0,double u1) const
{
	double I1 = 0.;

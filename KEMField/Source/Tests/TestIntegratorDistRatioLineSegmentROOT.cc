...
public:
	...
	void ComputeElectricFieldAndPotential(KLineSegment& l)
	{
		...
		fAnaElectricFieldAndPotential = std::make_pair( fAnaIntegrator.ElectricField(&l,fP), fAnaIntegrator.Potential(&l,fP) );

		fQuad2ElectricFieldAndPotential = std::make_pair(fQuadIntegrator.ElectricField_nNodes( data, fP, 1, gQuadx2, gQuadw2 ), fQuadIntegrator.Potential_nNodes( data, fP, 1, gQuadx2, gQuadw2 ));
		fQuad3ElectricFieldAndPotential = std::make_pair(fQuadIntegrator.ElectricField_nNodes( data, fP, 2, gQuadx3, gQuadw3 ),fQuadIntegrator.Potential_nNodes( data, fP, 2, gQuadx3, gQuadw3 ));
		fQuad4ElectricFieldAndPotential = std::make_pair(fQuadIntegrator.ElectricField_nNodes( data, fP, 2, gQuadx4, gQuadw4 ),fQuadIntegrator.Potential_nNodes( data, fP, 2, gQuadx4, gQuadw4 ));
		fQuad6ElectricFieldAndPotential = std::make_pair(fQuadIntegrator.ElectricField_nNodes( data, fP, 3, gQuadx6, gQuadw6 ),fQuadIntegrator.Potential_nNodes( data, fP, 3, gQuadx6, gQuadw6 ));
		fQuad8ElectricFieldAndPotential = std::make_pair(fQuadIntegrator.ElectricField_nNodes( data, fP, 4, gQuadx8, gQuadw8 ),fQuadIntegrator.Potential_nNodes( data, fP, 4, gQuadx8, gQuadw8 ));
		fQuad16ElectricFieldAndPotential = std::make_pair(fQuadIntegrator.ElectricField_nNodes( data, fP, 8, gQuadx16, gQuadw16 ),fQuadIntegrator.Potential_nNodes( data, fP, 8, gQuadx16, gQuadw16 ));
		fQuad32ElectricFieldAndPotential = std::make_pair(fQuadIntegrator.ElectricField_nNodes( data, fP, 16, gQuadx32, gQuadw32 ),fQuadIntegrator.Potential_nNodes( data, fP, 16, gQuadx32, gQuadw32 ));

		fNumElectricFieldAndPotential = std::make_pair(fQuadIntegrator.ElectricField( &l, fP ),fQuadIntegrator.Potential( &l, fP ));
#else
		...
		fQuad2ElectricFieldAndPotential = fQuadIntegrator.ElectricFieldAndPotential_nNodes( data, fP, 1, gQuadx2, gQuadw2 );
		fQuad3ElectricFieldAndPotential = fQuadIntegrator.ElectricFieldAndPotential_nNodes( data, fP, 2, gQuadx3, gQuadw3 );
		fQuad4ElectricFieldAndPotential = fQuadIntegrator.ElectricFieldAndPotential_nNodes( data, fP, 2, gQuadx4, gQuadw4 );
		fQuad6ElectricFieldAndPotential = fQuadIntegrator.ElectricFieldAndPotential_nNodes( data, fP, 3, gQuadx6, gQuadw6 );
		fQuad8ElectricFieldAndPotential = fQuadIntegrator.ElectricFieldAndPotential_nNodes( data, fP, 4, gQuadx8, gQuadw8 );
		fQuad16ElectricFieldAndPotential = fQuadIntegrator.ElectricFieldAndPotential_nNodes( data, fP, 8, gQuadx16, gQuadw16 );
		fQuad32ElectricFieldAndPotential = fQuadIntegrator.ElectricFieldAndPotential_nNodes( data, fP, 16, gQuadx32, gQuadw32 );
	...
	std::pair<KEMThreeVector,double>& GetQuad256ElectricFieldAndPotential() const { return fQuad256ElectricFieldAndPotential;}

	std::pair<KEMThreeVector,double>& GetAnaElectricFieldAndPotential() const { return fAnaElectricFieldAndPotential;}

	std::pair<KEMThreeVector,double>& GetQuad2ElectricFieldAndPotential() const { return fQuad2ElectricFieldAndPotential;}
	std::pair<KEMThreeVector,double>& GetQuad3ElectricFieldAndPotential() const { return fQuad3ElectricFieldAndPotential;}
	std::pair<KEMThreeVector,double>& GetQuad4ElectricFieldAndPotential() const { return fQuad4ElectricFieldAndPotential;}
	std::pair<KEMThreeVector,double>& GetQuad6ElectricFieldAndPotential() const { return fQuad6ElectricFieldAndPotential;}
	std::pair<KEMThreeVector,double>& GetQuad8ElectricFieldAndPotential() const { return fQuad8ElectricFieldAndPotential;}
	std::pair<KEMThreeVector,double>& GetQuad16ElectricFieldAndPotential() const { return fQuad16ElectricFieldAndPotential;}
	std::pair<KEMThreeVector,double>& GetQuad32ElectricFieldAndPotential() const { return fQuad32ElectricFieldAndPotential;}
...
private:
	...
	mutable std::pair<KEMThreeVector,double> fQuad256ElectricFieldAndPotential;
	...
	mutable std::pair<KEMThreeVector,double> fQuad2ElectricFieldAndPotential;
	mutable std::pair<KEMThreeVector,double> fQuad3ElectricFieldAndPotential;
	mutable std::pair<KEMThreeVector,double> fQuad4ElectricFieldAndPotential;
	mutable std::pair<KEMThreeVector,double> fQuad6ElectricFieldAndPotential;
	mutable std::pair<KEMThreeVector,double> fQuad8ElectricFieldAndPotential;
	mutable std::pair<KEMThreeVector,double> fQuad16ElectricFieldAndPotential;
	mutable std::pair<KEMThreeVector,double> fQuad32ElectricFieldAndPotential;
...
int main()
{
	...
	std::pair<KEMThreeVector,double> valQuad[7];
	...
	if( PLOTQUAD2 ) mgPot->Add( plotDrPotQuad2 );
	...
	if( PLOTQUAD3 ) mgPot->Add( plotDrPotQuad3 );
	...
	if( PLOTQUAD4 ) mgPot->Add( plotDrPotQuad4 );
	...
	if( PLOTQUAD6 ) mgPot->Add( plotDrPotQuad6 );
	...
	if( PLOTQUAD8 ) mgPot->Add( plotDrPotQuad8 );
	...
	if( PLOTQUAD16 ) mgPot->Add( plotDrPotQuad16 );
	...
	if( PLOTQUAD32 ) mgPot->Add( plotDrPotQuad32 );
	...
	if( PLOTQUAD2 ) mgField->Add( plotDrFieldQuad2 );
	...
	if( PLOTQUAD3 ) mgField->Add( plotDrFieldQuad3 );
	...
	if( PLOTQUAD4 ) mgField->Add( plotDrFieldQuad4 );
	...
	if( PLOTQUAD6 ) mgField->Add( plotDrFieldQuad6 );
	...
	if( PLOTQUAD8 ) mgField->Add( plotDrFieldQuad8 );
	...
	if( PLOTQUAD16 ) mgField->Add( plotDrFieldQuad16 );
	...
	if( PLOTQUAD32 ) mgField->Add( plotDrFieldQuad32 );
	...
	for( unsigned int k=0; k<=kmax; k++ ) {
		...
		if( PLOTQUAD2 ) plotDrPotQuad2->SetPoint( k, Dr, relQuad2Pot );
		if( PLOTQUAD3 ) plotDrPotQuad3->SetPoint( k, Dr, relQuad3Pot );
		if( PLOTQUAD4 ) plotDrPotQuad4->SetPoint( k, Dr, relQuad4Pot );
		if( PLOTQUAD6 ) plotDrPotQuad6->SetPoint( k, Dr, relQuad6Pot );
		if( PLOTQUAD8 ) plotDrPotQuad8->SetPoint( k, Dr, relQuad8Pot );
		if( PLOTQUAD16 ) plotDrPotQuad16->SetPoint( k, Dr, relQuad16Pot );
		if( PLOTQUAD32 ) plotDrPotQuad32->SetPoint( k, Dr, relQuad32Pot );
		...
		if( PLOTQUAD2 ) plotDrFieldQuad2->SetPoint( k, Dr, relQuad2Field );
		if( PLOTQUAD3 ) plotDrFieldQuad3->SetPoint( k, Dr, relQuad3Field );
		if( PLOTQUAD4 ) plotDrFieldQuad4->SetPoint( k, Dr, relQuad4Field );
		if( PLOTQUAD6 ) plotDrFieldQuad6->SetPoint( k, Dr, relQuad6Field );
		if( PLOTQUAD8 ) plotDrFieldQuad8->SetPoint( k, Dr, relQuad8Field );
		if( PLOTQUAD16 ) plotDrFieldQuad16->SetPoint( k, Dr, relQuad16Field );
		if( PLOTQUAD32 ) plotDrFieldQuad32->SetPoint( k, Dr, relQuad32Field );
	...
	KEMField::cout << "* 16-point quadrature: " << ((1.)*drOptPotQuad16) << " (no tolerance set here)" << KEMField::endl;
	KEMField::cout << "* 32-point quadrature: " << ((1.)*drOptPotQuad32) << " (no tolerance set here)" << KEMField::endl;
	...
	KEMField::cout << "* 16-point quadrature: " << ((1.)*drOptFieldQuad16) << " (no tolerance set here)" << KEMField::endl;
	KEMField::cout << "* 32-point quadrature: " << ((1.)*drOptFieldQuad32) << " (no tolerance set here)" << KEMField::endl;

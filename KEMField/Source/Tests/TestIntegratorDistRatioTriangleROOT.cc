...
public:
	...
	std::pair<KEMThreeVector,double>& GetCub16ElectricFieldAndPotential() const { return fCub16ElectricFieldAndPotential;}
	std::pair<KEMThreeVector,double>& GetCub19ElectricFieldAndPotential() const { return fCub19ElectricFieldAndPotential;}
...
private:
	...
	mutable std::pair<KEMThreeVector,double> fCub16ElectricFieldAndPotential;
	mutable std::pair<KEMThreeVector,double> fCub19ElectricFieldAndPotential;
...
int main()
{
	...
	std::pair<KEMThreeVector,double> valCub[6];

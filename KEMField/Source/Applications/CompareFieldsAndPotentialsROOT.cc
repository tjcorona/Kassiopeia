...
int main(int argc, char* argv[])
{
    ...
    double cylZmax( 4.43 );
    double cylR( 2.5 );
    std::vector<KEMThreeVector> tPositions;
    ...
    for( unsigned int i=0; i<noPoints; i++ ) {
        ...
        tPositions.push_back( KEMThreeVector(x,y,z) );
    }

    double pot1, pot2, potDiff, fieldDiff;
    KEMThreeVector field1, field2;
    std::pair<KEMThreeVector,double> set1;
    std::pair<KEMThreeVector,double> set2;

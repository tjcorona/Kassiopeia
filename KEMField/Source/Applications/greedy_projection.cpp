...
main (int argc, char** argv)
{
  ...
  gp3.setMaximumSurfaceAngle(KEMConstants::Pi/4); // 45 degrees
  gp3.setMinimumAngle(KEMConstants::Pi/18); // 10 degrees
  gp3.setMaximumAngle(2*KEMConstants::Pi/3); // 120 degrees
